package com.example.maksy.timproject.Controllers.Opinions;
...
public class AddOpinion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prepareFirebase();
        firebaseHelper.getDoctors(new FirebaseHelper.FirebaseObjectCallback() {
            @Override
    ...
    public void onButtonClick() {
        firebaseHelper.createOpinion(new FirebaseHelper.FirebaseObjectCallback() {
            @Override
            public void onCallback(List list) {
                notifyAdapter();
            }
