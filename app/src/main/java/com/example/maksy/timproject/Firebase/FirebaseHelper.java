...
import com.example.maksy.timproject.Controllers.Login.AfterLogin;
import com.example.maksy.timproject.Controllers.Login.LoginActivity;
...
public class FirebaseHelper {
    ...
    public void getDoctors(final FirebaseObjectCallback firebaseCallback) {
        firebaseDatabase = FirebaseDatabase.getInstance();
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                firebaseCallback.onCallback(doctors);
            }
    ...
    public void prepareDataForAppointments(final int flag, final FirebaseObjectCallback firebaseCallback) {
        Query query;
        databaseReference = firebaseDatabase.getReference("appointments");
        if (flag == 0) {
            firebaseAuth = FirebaseAuth.getInstance();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (flag == 2) {
                        ...
                        getPatientName(firebaseCallback,key, patientEmail, treatName, date);
                    }
                    getDoctorName(firebaseCallback,key, doctorEmail, treatName, date);
    ...
    private void getPatientName(final FirebaseObjectCallback firebaseCallback, final String key, final String patientEmail, final String treatName, final Long date) {
        databaseReference = firebaseDatabase.getReference("users");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                firebaseCallback.onCallback(doctorPatients);
            }
    ...
    public void getDoctorName(final FirebaseObjectCallback firebaseCallback, final String key, final String doctorEmail, final String treatName, final Long date) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                firebaseCallback.onCallback(appointments);
            }
